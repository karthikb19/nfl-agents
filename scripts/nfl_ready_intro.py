...
def main():
    # Load full-history pbp and team stats from nflreadpy.
    # Note: this may take a while and will hit the network.
    print("Loading play-by-play data for seasons 2000-2024...")
